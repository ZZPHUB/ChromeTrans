...
| **Full Translate** 📄 | Toggle full-page translation. Translates all paragraphs at once — replaces original text with translation. Click the inline ⇅ toggle button on any paragraph to flip between original and translation. Multi-layer filtering excludes nav, code, timestamps, and non-prose content. Each paragraph translated individually for accuracy. Cached across toggles. |
