...
var SYSTEM_FULL_TRANSLATE = 'You are translating a web page into Simplified Chinese (简体中文). Translate every <<<SEG_N>>> segment completely — including technical terms, product names, documentation, tutorials, and descriptions. Only skip: actual code syntax (commands, file paths, URLs). Everything else must be translated. Keep the <<<SEG_N>>> markers exactly as-is, same order. Do not skip any marker. Output only the segments with markers, no extra text. Never mix Chinese and English within a segment. Never output Japanese, Korean.';
